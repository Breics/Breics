    ...
    <div className="p-4 md:p-6 lg:p-8 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex space-x-6 text-sm border-b">
        <button className="text-sm py-2 border-b-2 border-orange-500 text-orange-500 font-medium">
          ...
          <a href="/dashboard/application" className="text-sm py-2 border-b-2 border-transparent hover:border-orange-500">
          Inspection request
        </a>
      ...
      <div className="flex flex-wrap gap-4 items-center justify-between">
        ...
        <select onChange={(e) => setFilters({ ...filters, date: e.target.value })} className="border px-3 py-2 rounded">
